<?php
  ...
  if(isset($_POST['create_submit'])){
    ...
    if(empty($username)){
      ...
      array_push($error, "<p class='alert alert-danger'>Invalid email!</p>");
      ...
      header("Location: ../../cms-admin.php?error=password_too_short");
    }
    else{
      if(empty($error)){
        ...
        switch($rand){
          case "1":
            $profile_pic = "users/profile_pics/defaults/default_1.png";
            break;
          case "2":
